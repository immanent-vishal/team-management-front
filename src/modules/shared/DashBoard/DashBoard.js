...
const DashBoard = () => {
  ...
  useEffect(() => {
    if (localStorage.getItem("connected") == undefined||localStorage.getItem("userId")==undefined) {
      history.push("/login");
    }
    loadChartData();
                    ...
                    <tbody>
                      {myTasks.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td>
                            {" "}
                            <span className="name">{item.deadline}</span>{" "}
                          </td>
                          <td>
                            {" "}
                          ...
                          <td>
                            <span className="count">{item.assigned}</span>
                          </td>
                          <td>
