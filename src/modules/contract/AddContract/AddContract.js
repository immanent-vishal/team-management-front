            ...
            <div class="form-group col-md-12">
              ...
              <div class="form-group">
                ...
                >
                  ...
                  {
                 clients.map((c,i)=> <option key={i} value={`${c.first_name} ${c.last_name}`}> {`${c.first_name} ${c.last_name}`}</option>)
                  }
                </select>
              </div>
              ...
              >
                ...
                <option value="Cost-reimbursable Contracts">
                  Cost-reimbursable Contracts
                </option>
                <option value="Time and materials (T&M)">
